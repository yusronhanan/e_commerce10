...
import 'package:e_commerce10/widgets/empty_widget.dart';
                        ...
                        : Flexible(
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  final product =
                                      bagViewModel.productsBag[index];
                                  return ListTile(
                      ...
                      Align(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              "Total: \$" +
                                  bagViewModel.totalPrice.toStringAsFixed(
                                      2), //forces only to display 2 decimal points in the total.
